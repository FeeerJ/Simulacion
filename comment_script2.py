...
files_to_comment = {
    'Simulacion.Application/PlantServices/LlegadaService.cs': {
        'public ResultadoCamioneta ProcesarNuevaCamioneta()': '        // Simula la llegada de una camioneta con dispositivos y filtra los que aplican (TVs/Monitores)\n        public ResultadoCamioneta ProcesarNuevaCamioneta()'
    },
    ...
    'Simulacion.Application/Services/StatisticalTestsService.cs': {
        'public Dictionary<string, object> RunChiSquareTest(List<double> data, int numIntervals)': '        // Ejecuta pruebas estadisticas (Chi-Cuadrado) para validar la uniformidad de la distribucion\n        public Dictionary<string, object> RunChiSquareTest(List<double> data, int numIntervals)'
    }
}
